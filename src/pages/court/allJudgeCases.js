                                                ...
                                                <div className="col-12 border-left">
                                                    <div className="staff_list row">
                                                        <div className="col-4 border-left">
                                                            ...
                                                            <small>
                                                                <b>Client name: </b>
                                                                {caseDetail.client_details.filer_name && caseDetail.client_details.filer_name
                                                                    .first_name +
                                                                    " " +
                                                                    caseDetail.client_details.filer_name && caseDetail.client_details.filer_name
                                                                        .last_name}
                                                            ...
                                                            <small>
                                                                <b>User Type: </b>
                                                                {caseDetail.client_details.filer_name && caseDetail.client_details.filer_name.user_type}
                                                            </small>
                                                            <br />
                                                            <br />
                                                            <b className="border-bottom border-dark">
